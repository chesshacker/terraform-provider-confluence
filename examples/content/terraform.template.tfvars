...
user  = "me@example.com"           # your Confluence user's email address
token = "XXXXXXXXXXXXXXXXXXXXXXXX" # create tokens here: https://id.atlassian.com/manage/api-tokens
space = "MYSPACE"                  # part of the URL after "/wiki/spaces/"
